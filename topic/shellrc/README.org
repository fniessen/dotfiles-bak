...
echo 'source ~/.dotfiles/plugins/solarized/mintty-solarized-dark.sh' >> ~/.zshrc # for light, replace dark with light
#+end_src
...
#+begin_note
See [[file:~/.dotfiles/repos/.oh-my-zsh/lib/key-bindings.zsh]] for extra key bindings.
#+end_note
