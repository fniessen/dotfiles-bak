...
* Shell functions
  :PROPERTIES:
  :header-args+: :tangle ~/.dotfiles/bin/shellutils :shebang #!/bin/bash
  :END:
...
** Send an email
   :PROPERTIES:
   :header-args+: :tangle ~/.dotfiles/bin/mail :shebang #!/bin/bash
   :END:
...
#+begin_src shell :tangle ~/.dotfiles/bin/findsn
#!/bin/bash
