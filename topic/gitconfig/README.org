...
*** Whose commit message mention your r-Segexp
...
More readable output, with grouping (like ~ack~):
...
Search for all matches occurring somewhere in files that match both patterns:
