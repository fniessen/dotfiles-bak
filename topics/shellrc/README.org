...
#+begin_src shell :tangle ../../files/.bash_profile
...
* Configuration related to Bash
  :PROPERTIES:
  :header-args+: :tangle ../../files/.bashrc
  :END:
...
** InputRC
   :PROPERTIES:
   :header-args+: :tangle ../../files/.inputrc
   :END:
...
* Configuration related to Zsh
  :PROPERTIES:
  :header-args+: :tangle ../../files/.zprofile
  :END:
...
* Configuration related to both shells
  :PROPERTIES:
  :header-args+: :tangle ../../files/.shellrc
  :END:
...
See [[file:~/src/git-config/SVN.org][SVN aliases]] for more information about these:
